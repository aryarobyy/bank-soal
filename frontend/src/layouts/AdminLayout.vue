  ...
  <div class="font-sans bg-gray-50 min-h-screen flex flex-col">
    <header class="sticky top-0 z-30 flex items-center justify-between px-4 md:px-[5%] py-4 bg-white border-b border-gray-200 shadow-sm">
      <div class="flex items-center gap-3">
        <button @click="toggleSidebar" class="p-2 text-gray-600 rounded-md hover:bg-red-50 hover:text-red-600 focus:outline-none transition-colors duration-200">
    ...
    <div class="flex flex-1 relative">
      ...
      <aside 
        :class="[
          'fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-2xl transform transition-transform duration-300 ease-out border-r border-gray-100',
      ...
      >
        <div class="h-full overflow-y-auto p-4 space-y-2">
          <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
            ...
            <button @click="isSidebarOpen = false" class="p-2 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-full transition-all duration-200">

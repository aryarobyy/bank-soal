		...
		<form @submit.prevent="handleSubmit" class="space-y-4">
			<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				<div>
					...
					<input v-model="localData.fullName" type="text"
				...
				<div>
					...
					<input v-model="localData.idNumber" type="text"
						class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
				...
				<div>
					...
					<select v-model="localData.gender"
						class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
				...
				<div class="md:col-span-2">
					...
					<textarea v-model="localData.history" rows="3"
						class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
						placeholder="Riwayat pendidikan atau informasi lainnya"></textarea>
				</div>
			</div>

			<div v-if="localData.imageUrl" class="mt-4">
				<label class="block text-sm font-medium text-gray-700 mb-1">Foto Profil</label>
				<img :src="localData.imageUrl" alt="Foto Profil"

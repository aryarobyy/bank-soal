        ...
        <ul class="flex flex-col p-4 space-y-2">
          <template v-if="user">
            ...
            <li class="pt-3 mt-2 border-t border-gray-100">
              <div
                class="flex items-center gap-2 px-3 mb-2 text-gray-500 font-medium text-xs uppercase tracking-wider"
              >
                <User class="w-4 h-4" />
            ...
            <li>
              <RouterLink
                :to="`/profile/${user.id}`"
                class="block px-3 py-2 text-sm font-medium text-gray-700 rounded-md hover:bg-blue-50 hover:text-blue-600"
                @click="closeMobileMenu"
              >
                Lihat Profil
              </RouterLink>
            ...
            <li>
              <button
                @click="handleLogout"
                class="w-full text-left block px-3 py-2 text-sm font-medium text-red-600 rounded-md hover:bg-red-50"
              >
                Logout
              </button>
            </li>
          ...
          <template v-else>
            ...
            <li>
              <RouterLink
                to="/register"
                :class="mobileLinkClass('/register')"
                @click="closeMobileMenu"
              >
                Register
              </RouterLink>
